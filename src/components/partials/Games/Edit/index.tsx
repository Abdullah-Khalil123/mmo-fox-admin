            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                ...
                <div>
                  ...
                  />
                  {errors.slug && (
                    <ErrorInput>{errors.slug.message}</ErrorInput>
                  )}
                </div>
              </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        {errors.seo?.[index]?.language && (
                          <ErrorInput>
                            {errors.seo[index].language?.message as string}
                          </ErrorInput>
                        )}
                      </div>
                      <div className="md:col-span-2">
                        ...
                        {errors.seo?.[index]?.metaTitle && (
                          <ErrorInput>
                            {errors.seo[index].metaTitle?.message as string}
                          </ErrorInput>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="mt-6">
                      <div className="mt-4">
                        ...
                        {errors.seo?.[index]?.keywords && (
                          <ErrorInput>
                            {errors.seo[index].keywords?.message as string}
                          </ErrorInput>
                        )}
                      </div>
                    </div>
